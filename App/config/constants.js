...
export default function constants(isStaging) {
    return {
        ...
        MaritimeAuthURI: `${isStaging ? staging.baseURI : baseURI}/realms/MaritimeCloud/protocol/openid-connect/auth?client_id=${encodeURIComponent(isStaging ? staging.clientID : clientID)}&redirect_uri=${encodeURIComponent(isStaging ? staging.redirectURI : redirectURI)}&response_mode=fragment&response_type=code&scope=openid`,
