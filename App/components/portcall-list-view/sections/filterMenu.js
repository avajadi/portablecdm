    ...
    buttonStyle: { 
     ...
     //   paddingLeft: 50,
      ...
      //Vanliga Buttons SORT BY
            ...
            //             borderRadius = {3}
            //             backgroundColor= {colorScheme.primaryContainerColor}
            //             onPress={() => console.log('Arrival Date was pressed')}
            //         />
            //         <Button
            //             title= {`Last\nUpdate`}
            //             underlayColor= 'orange'
            ...
            //             borderRadius = {3}
            //             backgroundColor= {colorScheme.primaryContainerColor}
            //             onPress={() => console.log('Last Update was pressed')}
            //         />
            //         <Button
            //             title= {`Vessel\nName`}
            //             underlayColor='orange'
            ...
            //           //  fontSize={9}
            //             backgroundColor= {colorScheme.primaryContainerColor}
            //             onPress={() => console.log('Vessel Name was pressed')}
            //         />
            //     </View>
            // </View>

    // Vanliga Buttons ORDER BY
