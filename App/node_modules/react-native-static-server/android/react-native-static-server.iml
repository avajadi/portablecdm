...
<module external.linked.project.id=":react-native-static-server" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":react-native-static-server" />
      </configuration>
    </facet>
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7" inherit-compiler-output="false">
    ...
    <orderEntry type="library" exported="" name="react-native-18.0.0" level="project" />
    <orderEntry type="library" exported="" name="jsr305-3.0.0" level="project" />
    <orderEntry type="library" exported="" name="bolts-tasks-1.4.0" level="project" />
    <orderEntry type="library" exported="" name="nanohttpd-webserver-2.3.1" level="project" />
    ...
    <orderEntry type="library" exported="" name="nanohttpd-2.3.1" level="project" />
